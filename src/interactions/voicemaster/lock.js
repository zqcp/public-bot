...
module.exports = {
    ...
    async execute(
        ...
        if (
            ...
            const embed =
                new EmbedBuilder()
                    ...
                    .setDescription(
                        `${config.emojis.error} ${interaction.user}: Your **voice channel** is already locked.`
                    );
        ...
        try {
            ...
            console.error(
                "[VC LOCK BUTTON] Failed to lock channel:",
                error
            );
            ...
            return interaction.reply({
                embeds: [
                    new EmbedBuilder()
                        ...
                        .setDescription(
                            `${config.emojis.failed} ${interaction.user}: I couldn't lock your **voice channel**.`
                        )
                ],
                flags: 64
            });
        ...
        try {
            ...
            console.error(
                "[VC LOCK BUTTON] Failed to move channel:",
                error
            );
        ...
        const embed =
            new EmbedBuilder()
                ...
                .setDescription(
                    `🔒 ${interaction.user}: Your **voice channel** has been locked.`
                );
