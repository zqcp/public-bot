        ...
        try {
            ...
            const embed =
                new EmbedBuilder()
                    ...
                    .setDescription(
                        `${config.emojis.success} ${message.author}: Banned **${target.user.username}** for ${reason}.`
                    );
            ...
            console.error(
                `[BAN] Failed to ban ${target.user.tag}:`,
                error
            );
            ...
            const embed =
                new EmbedBuilder()
                    ...
                    .setDescription(
                        `${config.emojis.failed} ${message.author}: Ban failed for **${target.user.username}**. Please try again.`
                    );
