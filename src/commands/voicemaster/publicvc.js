...
module.exports = {
    ...
    async execute(
        ...
        /*
         * Save public category
         */

        voiceMaster.publicCategoryId =
            category.id;
        ...
        const embed =
            new EmbedBuilder()
                ...
                .setDescription(
                    `${config.emojis.success} ${message.author}: Public VoiceMaster category set to **${category.name}**.`
                );
